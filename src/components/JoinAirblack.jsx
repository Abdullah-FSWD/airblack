...
const JoinAirblack = () => {
  return (
    <div
      ...
      className={`bg-local bg-repeat bg-center  max-w-screen-sm sm:max-w-screen-lg lg:max-w-screen-2xl h-[18.50875rem] bg-black/95 flex flex-col justify-center items-center gap-8`}>
      <div className="w-[20.4375rem] flex flex-row gap-[1.5625rem]">
        <img src={vector} />
        <h1 className="text-[#F5F5F5] text-2xl font-roca w-[11.75rem] text-center">
      ...
      <div className="flex flex-row gap-[0.6875rem]">
        <div className="flex flex-col justify-between items-center gap-2 h-[4.75875rem] w-[6.5rem] transition-transform duration-300 hover:scale-110">
          <img src={zoom} />
          <p className="font-nova text-center font-normal text-[0.6875rem] text-white leading-4">
            Do-it-together,
            <br />
            live on zoom
          </p>
