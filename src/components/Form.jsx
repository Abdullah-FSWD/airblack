      ...
      <div className=" flex flex-col gap-[1.25rem] p-[0.625rem]">
        <form className="flex flex-col gap-[0.625rem]">
          <div className="w-[19.1875rem] h-[3.875rem] flex flex-col gap-[0.6875rem]">
            <label
              className="block text-[#505050] text-[0.8rem] font-semibold font-ping"
              htmlFor="name">
              {"*Enter your name"}
            </label>
            <input
          ...
          <div className="w-[19.1875rem] h-[3.875rem] flex flex-col gap-[0.6875rem]">
            ...
            <div className="flex flex-row gap-[0.6875rem]">
              <select
                ...
                id="countrycode"
                required>
                <option defaultValue="+91" value="1">
                  +91
                </option>
          ...
          <div className="w-[19.1875rem] h-[3.875rem] flex flex-col gap-[0.6875rem]">
            ...
            <select
              className={`px-3 py-2 border border-[#D9D9D9] rounded h-[2.1875rem] font-ping text-[0.8475rem]  ${
                !selectedProf ? "text-[#BFBFBF]" : "text-black"
              }`}
              id="profession"
              value={selectedProf}
          ...
          <div className="w-[19.1875rem] h-[3.875rem] flex flex-col gap-[0.6875rem]">
            ...
            <select
              className={`px-3 py-2 border border-[#D9D9D9] rounded h-[2.1875rem] font-ping text-[0.8475rem]  ${
                !selectedGoal ? "text-[#BFBFBF]" : "text-black"
              }`}
              id="goal"
              value={selectedGoal}
          ...
          <div className="w-[19.1875rem] h-[3.875rem] flex flex-col gap-[0.6875rem]">
            ...
            <select
              className={`px-3 py-2 border border-[#D9D9D9] rounded h-[2.1875rem] font-ping text-[0.8475rem]  ${
                !selectedCity ? "text-[#BFBFBF]" : "text-black"
              }`}
              id="city"
              value={selectedCity}
